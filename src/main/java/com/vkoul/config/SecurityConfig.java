...
import com.vkoul.service.UserServiceImpl;
...
class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		//, "/createUser"
		http.authorizeRequests().antMatchers("/", "/favicon.ico", "/resources/**", "/createUser").permitAll()
				...
				.permitAll().logoutSuccessUrl("/signin?logout");
				http.csrf().disable();
	}
}